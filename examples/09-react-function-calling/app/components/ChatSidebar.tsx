    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg h-full flex flex-col">
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 mt-1">
          <span>ReAct模式: 推理→行动 | 消息: {messages.length}</span>
          ...
          <div className="space-y-4">
            {messages.length === 0 && (
              <div className="text-center text-gray-500 dark:text-gray-400 mt-8">
                ...
                <p>你好！我是你的 ReAct AI 助手</p>
                <p className="text-sm mt-1">支持复合指令，我会逐步思考并执行</p>
                <p className="text-xs mt-1 text-blue-600 dark:text-blue-400">
                  💡 试试：&ldquo;添加两个学习任务，然后显示列表&rdquo;
                </p>
              </div>
            )}
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 p-3">
        <form onSubmit={handleFormSubmit} className="flex gap-2">
          <input
            ...
            placeholder="输入复合指令，如'添加任务后显示列表'，我会逐步思考执行..."
            disabled={isLoading}

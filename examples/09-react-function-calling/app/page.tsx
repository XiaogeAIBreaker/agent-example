        ...
        <div className="flex-1 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 overflow-y-auto">
          <div className="mb-4">
            <h1 className="text-3xl font-bold text-center text-gray-800 dark:text-white mb-2">
              🧠 ReAct + Function Calling 联合实战
            </h1>
            <p className="text-center text-sm text-gray-600 dark:text-gray-400">
              多步任务规划 ➝ 多次函数调用 ➝ 汇总执行结果 | 支持操作: {getSupportedActions().join(', ')}
            </p>
            <p className="text-center text-xs text-gray-500 dark:text-gray-500 mt-1">
              💡 体验ReAct模式：思考(Thought) → 行动(Action) → 观察(Observation) 循环推理
            </p>
            <div className="text-center text-xs text-blue-600 dark:text-blue-400 mt-2 space-y-1">
              <div>🎯 试试说：&ldquo;写日报前先完成当前的任务&rdquo;</div>
              <div>🔄 观察AI的完整ReAct推理过程</div>
            </div>
          </div>

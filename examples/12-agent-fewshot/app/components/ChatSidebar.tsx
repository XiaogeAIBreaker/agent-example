    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg h-full flex flex-col">
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 mt-1">
          <span>Agent CoT: 思考过程可视化 | 消息: {messages.length}</span>
          ...
          <div className="space-y-4">
            {messages.length === 0 && (
              <div className="text-center text-gray-500 dark:text-gray-400 py-8">
                ...
                <h3 className="text-lg font-medium mb-2">Agent CoT 助手</h3>
                <p className="text-sm">
                  我会展示思考过程，让决策透明可见，帮你完成复杂任务
                </p>
                <div className="mt-4 text-xs space-y-1">
                  <p>💡 试试说：&ldquo;今天任务很多，帮我安排出最重要的三件事&rdquo;</p>
